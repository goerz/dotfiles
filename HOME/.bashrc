...
export PATH=$HOME/bin:$HOME/.cabal/bin:$HOME/anaconda/envs/python34/bin:/Library/TeX/texbin/:/usr/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/X11/bin:/usr/X11R6/bin:/usr/X11/bin
